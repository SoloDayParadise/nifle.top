<script>
	...
	function charRarityToColor(rarityNum) {
		...
		else if (rarityNum == 3) return '#8DA3CE';
		else if (rarityNum == 2) return '#9ECE8D';
		else return '#151515';
	}
</script>
...
<div class="page-wrapper">
	...
	<div class="item-grid">
		{#each filteredWeapons as weapon (weapon.id)}
			...
			<a href="/weapons/{weapon.id}" class="item-card">
				<img
					src="/CommonIcons/T_Armory_WeaponType_{weapon.type}.png"
					alt="Attribute"
